...
create table storage.providers (
    ...
    constraint providers_code_length check (octet_length(provider_code) between 1 and 256),
    constraint providers_key_length check (octet_length(provider_key) between 1 and 256),
...
create table storage.dimensions (
    ...
    constraint dimensions_key_length check (octet_length(dimension_key) between 1 and 256),
...
create table storage.categories (
    ...
    constraint categories_key_length check (octet_length(category_key) between 1 and 256),
